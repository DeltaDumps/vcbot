...
class HellClient(Client):
    ...
    async def start(self):
        LOGS.info(
            "\x3e\x3e\x20\x42\x6f\x6f\x74\x69\x6e\x67\x20\x75\x70\x20\x48\x65\x6c\x6c\x4d\x75\x73\x69\x63\x2e\x2e\x2e"
        )
        if Config.BOT_TOKEN:
            ...
            LOGS.info(
                f"\x3e\x3e\x20{self.app.name}\x20\x69\x73\x20\x6f\x6e\x6c\x69\x6e\x65\x20\x6e\x6f\x77\x21"
            )
        if Config.HELLBOT_SESSION:
            ...
            try:
                ...
                pass
            LOGS.info(
                f"\x3e\x3e\x20{self.user.name}\x20\x69\x73\x20\x6f\x6e\x6c\x69\x6e\x65\x20\x6e\x6f\x77\x21"
            )
        LOGS.info(
            "\x3e\x3e\x20\x42\x6f\x6f\x74\x65\x64\x20\x75\x70\x20\x48\x65\x6c\x6c\x4d\x75\x73\x69\x63\x21"
        )
